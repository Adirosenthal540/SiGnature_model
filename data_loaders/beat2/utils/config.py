...
def parse_args():
    ...
    parser.add("-c", "--config", default="./dataset/emage.yaml", is_config_file=True)
    ...
    parser.add("--data_amass_path", default="/datasets/AMASS-SMPLX/", type=str)
    parser.add("--data_seg_path", default="./datasets/SeG_SMPLX/seg_dataset_new_skeleton", type=str)
    ...
    parser.add("--vae_quantizer_lambda", default=1.0, type=float)

    parser.add("--vae_layer", default=2, type=int)
    parser.add("--vae_grow", default=[1, 1, 2, 1], type=int, nargs="*")
    parser.add("--lf", default=0.0, type=float)
    parser.add("--ll", default=0.0, type=float)
    parser.add("--lu", default=0.0, type=float)
    parser.add("--lh", default=0.0, type=float)
    parser.add("--cf", default=0.0, type=float)
    parser.add("--cl", default=0.0, type=float)
    parser.add("--cu", default=0.0, type=float)
    parser.add("--ch", default=0.0, type=float)
    ...
    parser.add("--ttmr", default=0.0, type=float)
    parser.add("--mtmr", default=0.0, type=float)
    parser.add("--ftmr", default=0.0, type=float)
    parser.add("--asmr", default=0.0, type=float)
    parser.add("--tsmr", default=0.0, type=float)
    parser.add("--msmr", default=0.0, type=float)
    parser.add("--fsmr", default=0.0, type=float)
    #    parser.add("--m_encoder", default=None, type=str)
    ...
    parser.add("--test_stride", default=10, type=int)
    ...
    parser.add("--weight_decay", default=0.0, type=float)
    ...
    parser.add("--render_video_width", default=1920, type=int) #1440
    ...
    parser.add("--plot_video", default=True, type=str2bool)
    # logging
