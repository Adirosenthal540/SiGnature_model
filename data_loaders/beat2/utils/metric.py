...
class alignment(object):
    ...
    def load_pose(self, pose, t_start, t_end, pose_fps, without_file=False, return_vel=False):
        data_each_file = []
        if without_file:
        ...
        if return_vel:
            return beat_vel_all, vel  # beat_right_arm, beat_right_shoulder, beat_right_wrist, beat_left_arm, beat_left_shoulder, beat_left_wrist
